            ...
            @forelse ($users as $user)
                <tr wire:key="{{ $user->id }}">
                    ...
                    <td>
                        ...
                        @elseif ($user->role == 1)
                            <span class="badge bg-warning-subtle text-warning-emphasis rounded-pill">Arsip</span>
                        @else
                            <span class="badge bg-success-subtle text-success-emphasis rounded-pill">Bidang</span>
                        @endif
                    </td>
